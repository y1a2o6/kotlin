    ...
    public static void generateParameterAnnotations(
        ...
        for (int i = 0; i < kotlinParameterTypes.size(); i++) {
            ...
            if (annotated != null) {
                ...
                KotlinType type = annotated.getType();
                AnnotationCodegen.writeTypeAnnotations(mv, state, parameterIndex, type);
            }
        }

        AnnotationCodegen.writeTypeAnnotations(mv, state, -1, functionDescriptor.getReturnType());
    }
